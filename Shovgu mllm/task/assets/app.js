...
// let ortalama= scr.reduce((acc , value)=>{
//     let ortalamascr = value.scores.reduce((acc,value)=>{
//         acc+=value
//         return acc;
//     },)
// acc=ortalamascr/3
...
let countries = ["Azerbaijan", "albania" ,"Germany", "amerika", "russian"];
...
let password= students.map((acc , value)=>{
    let parol = acc.loginDetail.password
for (let i = 0; i < parol.length; i++) {
console.log(parol.substring(0,4))    
}
})
